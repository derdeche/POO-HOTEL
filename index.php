...
$reservation1 = new Reservation($client1, '01-01-2021','03-01-2021',17);
$reservation2 = new Reservation($client2, '04-01-2021','06-01-2021',3);
$reservation3 = new Reservation($client2, '08-04-2021','10-04-2021',4);
